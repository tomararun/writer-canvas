...
const themes = [
  ...
  {
    title: "Attention",
    body: "What we protect, what we spend, and what it costs to be interruptible.",
  },
    ...
    <>
      ...
      <section className="wrap py-16 md:py-24">
        <div className="grid gap-16 md:grid-cols-[2fr_1fr]">
          <div className="prose-editorial">
            <p>
              I started in magazines, where I learned that most writing problems are structure
              problems wearing a costume. Then I spent five years inside software companies, where I
              learned that most structure problems are actually organisational ones.
            </p>
            <p>
              Now I split my time between my own essays and editorial systems work for publications
              and product teams — voice guides, information architecture, article patterns, the
              unglamorous scaffolding that lets other people write well consistently.
            </p>
            <p>
              I publish everything here: finished essays, case studies with the messy middle
              included, and a weekly journal of whatever I am currently bad at.
            </p>
          </div>
          ...
          <aside className="border-l border-rule pl-6">
            ...
            <ul className="mt-4 grid gap-4 text-sm leading-relaxed">
              {values.map((v) => (
                <li key={v} className="border-b border-rule pb-4 last:border-0">
                  {v}
                </li>
              ))}
            </ul>
      ...
      <section aria-labelledby="themes" className="border-y border-rule bg-paper">
        <div className="wrap py-16 md:py-24">
          <h2 id="themes" className="font-display text-3xl sm:text-4xl">
            Writing themes
          </h2>
          ...
          <div>
            ...
            <ol className="mt-8 grid gap-6">
              {timeline.map(([year, body]) => (
                <li
                  key={year}
                  className="grid grid-cols-[4rem_1fr] gap-4 border-b border-rule pb-6"
                >
